<template>
  <article class="legal-page">
    ...
    <section>
      <h2>3. Wann wir erstatten</h2>
      <p>Wir prüfen Rückerstattungsanfragen fair und erstatten insbesondere, wenn:</p>
      <ul>
        <li>technisch kein Credit gutgeschrieben wurde, obwohl die Zahlung erfolgreich war,</li>
        <li>ein doppelter Kauf bzw. eine doppelte Belastung nachweisbar ist,</li>
        <li>ein schwerwiegender Fehler die Nutzung der freigeschalteten Credits verhindert,</li>
    ...
    <section>
      <h2>4. Wie du eine Erstattung beantragst</h2>
      <p>
        Schreibe an
        <a href="mailto:christian.murschall@googlemail.com">christian.murschall@googlemail.com</a>
      ...
      <p>
        ...
        <a href="https://paddle.net" target="_blank" rel="noreferrer">paddle.net</a>.
      </p>
    </section>
